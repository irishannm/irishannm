...
- **Postman API (On-going)**: [Postman API Exercises](https://github.com/irishannm/Postman-API-Exercise)
- **Test Case Creation (On-going)**: [Test Case Spreadsheet](https://docs.google.com/spreadsheets/d/1RUZBmGxDipnJszgwgpN8Bcy7zlVcasH3gtvidcjhDh4/edit?usp=sharing)
